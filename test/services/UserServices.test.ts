...
describe('test UserServices', () => {
	let nome = 'felipe';
	let email = 'fucas@gmail.com';
	let senha = '123456';

	let id1 = 1;
	let nome2 = 'lucas';
	let email2 = 'lucas@gmail.com';
	let senha2 = '123456';

	let nome3 = 'nome trocado';

	let id2 = 2;
	let nome4 = 'gilson';
	let email4 = 'gilson@gmail.com';
	...
	it('should not find a user by id', async () => {
		const userFound = await userServices.getUserById(999);
